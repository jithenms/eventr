...
function NewEvent() {
  ...
  // used to create state variables for meridiem and quarter with initial values of 'PM' and 1
        ...
        <div className="w-full mx-auto p-5">
          <div className="text-center mb-16 mt-4">
            <h3 className="text-3xl sm:text-4xl leading-normal font-extrabold tracking-tight text-gray-900 font-poppins">
              Create a new <span className="text-indigo-600">Event</span>
            </h3>
          </div>
              ...
              createEvent({
                variables: {
                  CreateEventInput: {
                    ...
                    date: values.date,
                    time: moment(`${values.time} ${meridiem}`, [
                      "hh:mm A",
                    ]).format("HH:mm"),
          ...
          >
            {(formik) => {
              ...
              return (
                // form fields include a title input, description input, date input, time input, point value input, and a "Create Event" button to submit the form.
                    ...
                    <div className="flex items-center justify-between w-full gap-12">
                      ...
                      <div>
                        <select
                          ...
                          className="border py-2 rounded-lg outline-none bg-gray-200"
                        >
                          <option defaultValue={1}>Quarter 1</option>
