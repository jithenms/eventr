...
function RegisterStudent() {
  ...
  // function is used to check that all required fields are filled out before submitting the form
  ...
  // uses the useMutation hook from @apollo/client to create a new student in the database and the useAuth hook to sign in the newly created user
  const [createStudent, { data, loading, error }] = useMutation(CREATE_STUDENT);

  //   If loading is true, it displays a LoadingScreen component. If an error occurs, it logs the error to the console
    ...
    <div class="bg-[#F3F7F9] min-h-screen flex flex-col">
      <div class="container max-w-sm mx-auto flex-1 flex flex-col items-center justify-center px-2">
        <div class="bg-white px-6 py-8 rounded shadow-md text-black w-full">
          ...
          {/*  
            uses Formik for form handling and validation, with the initial values and validation functions defined within the component. 
            The onSubmit function calls the createStudent mutation and then signs the user in.
          */}
          <Formik
